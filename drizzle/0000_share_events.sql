...
CREATE INDEX IF NOT EXISTS "share_events_slug_created_idx" ON "share_events" USING btree ("report_slug", "created_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "share_events_created_idx" ON "share_events" USING btree ("created_at");
