...
- **formal-transitions**: "Moreover" and "furthermore" in casual writing (LinkedIn, blogs, newsletters). In academic papers, research abstracts, legal writing, or formal reports, these are appropriate and should NOT be flagged. If the source text reads like an academic abstract or research summary — formal register, hedged claims, methodology language — do NOT flag formal-transitions. Example: "Furthermore, the study found..." in a research abstract is correct academic writing, not an AI tell.
