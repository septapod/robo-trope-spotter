      ...
      {!expanded ? (
        ...
        <>
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl border border-zinc-200 bg-white px-4 py-3 font-mono text-sm tracking-wide text-zinc-500 transition-all hover:border-candy-pink/40 hover:text-candy-pink shadow-sm"
          >
            <svg
